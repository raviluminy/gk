...
\begin{figure}[htbp]
	...
	\begin{tikzpicture}
		...
		% #### CADRE VERT :
		% Fond :
		\draw[fill=green!10] (0,6) rectangle (17, 11);
		\draw[fill=red!10] (2,11) rectangle (11, 6);
		% Titres :
		\node[titre] at (6.50,6.00) {Serveur local};
		% Serveurs :
		...
		% Traits :
		\draw[line width=2pt] (1.5, 8.5) -- (2.5, 8.5);
		\draw[line width=2pt] (5.5, 8.5) -- (7.5, 8.5);
		\draw[line width=2pt] (10.5, 8.5) -- (12.5, 8.5);
		% Utilisateurs :
		\umlactor[x=1.00, y=8.50]{Utilisateur}
	\end{tikzpicture}
	\caption{Cluster, serveur mâitre et esclave directement connecté}
