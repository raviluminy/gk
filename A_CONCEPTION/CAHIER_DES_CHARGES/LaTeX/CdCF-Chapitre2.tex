...
\node[fill=black!5,draw=ocre,text=black] (U)  at (0,0) [rectangle,draw] {\begin{tabular}{c}Utilisateur\end{tabular}};
\node[fill=black!5,draw=ocre,text=black] (GU) at (4,0) [rectangle,draw] {\begin{tabular}{c}Groupe d'utilisateurs\end{tabular}};
\node[fill=black!5,draw=ocre,text=black] (DA) at (8,0) [rectangle,draw] {\begin{tabular}{c}Droits d'accès\end{tabular}};
...
\umlusecase{Bob l'éponge}
\umlusecase{Joe}
\umlusecase{Joe Bob}
\umlusecase{Marie}
\umlusecase{Jane}
\umlusecase{Marie Jane}
\umlusecase{Marie Jone Bob}
...
\umlactor{Utilisateur}
\umlactor[y=-3]{subuser}
\umlactor[x=14, y=-1.5]{admin}

\umlinherit{subuser}{Utilisateur}
