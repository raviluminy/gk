...
% Fin de la section [Listes exhaustives des éléments et contraintes]
...
\end{itemize}
\mo espère ainsi améliorer le fonctionnement global de l'organisation en suivant la logique décrite dans la Fig. \ref{arbre_probleme}.
% Arbre à problème :
\begin{figure}[h]
\centering
\begin{tikzpicture}
...
Les prestations attendues sont la suite logicielle, le matériel (si nécessaire) et un service support.
