...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[scale=1]{pagedegarde}}} % Image background
...
%{\bfseries\title} % Book title
%\vspace*{1cm}
%\subject\par % Book subject
%\vspace*{1cm}
...
\chapterimage{entete_sciences.pdf} % Table of contents heading image
...
%\chapterimage{entete.pdf} % Chapter heading image
