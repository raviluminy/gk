...
\hypersetup{
      ...
      pdfkeywords = {AMO, GK, TMS, CdC, DAT, PIT}
}
% Thème du pdf 
\usetheme{Warsaw}
...
\include{Presentation_Amo_Objectifs_pour_Garmir_Khatch}
...
\include{Presentation_Me_Solution_Disponibilite}

\include{Presentation_Me_Solution_Synchronisation}

\include{Presentation_Me_Solution_Securite}
