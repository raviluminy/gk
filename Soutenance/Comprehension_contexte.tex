...
\begin{frame}
\frametitle{Contexte métier}
\begin{block}{La logistique} \pause
\begin{itemize}
\item Les processus et les fonctions clefs de la logistique \pause
\item Les logisticiens de terrain \pause
 \item  Les transports
 \end{itemize}
\end{block}
\end{frame} 
...
\begin{block}{Espérance de retour sur investissement}
...
\subsubsection{Contexte de réalisation}
\begin{frame}
\frametitle{Contexte de réalisation} \pause
\begin{block}{Points clefs} \pause
\begin{itemize}
\item Études déjà  effectuées \pause
\item Nature des prestations demandées \pause
\item Parties concernées
\end{itemize}
...
\begin{frame}
\frametitle{Énoncé du besoin} \pause
\begin{block}{Architecture générale} \pause
\begin{enumerate}
\item  Utilisateurs \pause
\item Matériels \pause
\item Application \pause
\item Synchronisation \pause
\item Serveur local \pause
\item Synchronisation \pause
\item Serveur central
\end{enumerate}
\end{block}
\end{frame}